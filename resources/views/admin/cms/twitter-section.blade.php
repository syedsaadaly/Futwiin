    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary" data-aos="fade-up" data-aos-duration="1000">
                ...
                <form id="update-section-form" action="{{ route('admin.twitter-section.update') }}" method="POST"
                    style="display:none;">
                    @csrf
                    @method('PUT')
                </form>
                <div class="card-body table-responsive">
                    ...
                    <form action="{{ route('admin.twitter-items.store') }}" method="POST" class="mb-4">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="content" placeholder="Tweet Content" class="form-control"
                                    required>
                            </div>
                            <div class="col-md-2">
                                ...
                                <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('admin.twitter-items.update', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-2">
                                                        <label>Handle</label>
                                                        <input type="text" name="handle" value="{{ $item->handle }}"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="mb-2">
                                                        <label>Content</label>
