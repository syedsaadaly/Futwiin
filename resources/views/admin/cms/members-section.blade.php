        ...
        <div class="col-12">
            <div class="card card-primary" data-aos="fade-up" data-aos-duration="1000">
                <div class="card-header text-white" style="background-color: rgb(0,0,0);">
                    <h1 class="page-heading mb-0" style="font-size: 22px;">Members Section</h1>
                </div>

                <form action="{{ route('cms.members-section.update', $memberSection->slug) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" value="{{ $decodedContent['page_title'] ?? '' }}"
                                class="form-control" placeholder="Enter section title">
                        </div>
                        <div class="form-group mb-3">
                            <label class="fw-bold">Image</label>
                            <input type="file" name="image" class="form-control">
                            @if ($memberSection->getFirstMediaUrl('image'))
                                <div class="mt-2">
                                    <img src="{{ $memberSection->getFirstMediaUrl('image') }}" alt="Members Image"
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-dark"><i class="fas fa-save me-1"></i> Update Section</button>
                    </div>
                </form>
            </div>
            ...
            <div class="card card-primary mt-4" data-aos="fade-up" data-aos-duration="1000">
                <div class="card-header text-white" style="background-color: rgb(0,0,0);">
                    <h1 class="page-heading mb-0" style="font-size: 22px;">Member Points</h1>
                </div>
                ...
                <form action="{{ route('cms.members-section.storePoint') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-success"><i class="fas fa-plus me-1"></i> Add Point</button>
                    </div>
                </form>
