                ...
                <form action="{{ route('cms.how-it-works.update') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" value="{{ old('title', $howItWorks->title ?? '') }}"
                                class="form-control" placeholder="Enter section title">
                        </div>

                        <div class="form-group mb-3">
                            <label class="fw-bold">Subtitle</label>
                            <textarea name="subtitle" rows="3" class="form-control" placeholder="Enter section subtitle">{{ old('subtitle', $howItWorks->subtitle ?? '') }}</textarea>
                        </div>
