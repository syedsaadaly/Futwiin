...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-primary shadow-sm" data-aos="fade-up" data-aos-duration="1000">
            ...
            {{-- Form --}}
            <form action="{{ route('admin.featured-players.update', $player) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="stats" value="{{ old('stats', $player->stats) }}" class="form-control">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($player->image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/'.$player->image) }}" alt="{{ $player->name }}" width="120" class="rounded shadow-sm border">
                            </div>
                        @endif
                    </div>
