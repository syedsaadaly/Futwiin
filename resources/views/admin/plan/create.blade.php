            ...
            <div class="card card-primary" data-aos="fade-up" data-aos-duration="1000">
                <div class="card-header text-white pb-0" style="background-color: rgb(0, 0, 0);">
                    <h1 style="font-size: 24px">
                        {{ $pageData->pageName ?? 'Create New Plan' }}
                    </h1>
                </div>

                <div class="card-body">
                    <form name="create_plan_form" id="create_plan_form" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="points" name="points" placeholder="Enter Points" required min="0">
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="text" name="text" placeholder="Enter Description" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
