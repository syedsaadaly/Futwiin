...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        {{-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ route('assets', app_setting('header_logo', '')) }}" alt="AdminLTELogo" style="max-width: 220px;">
        </div> --}}
            ...
            <ul class="navbar-nav">
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link text-dark" href="#"
                        style="font-size: 30px; font-weight:500; line-height:1;">
            ...
            <ul class="navbar-nav ml-auto" style="display: flex; align-items:center;">
                ...
                <li class="nav-item dropdown" style="margin-right: 50px;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-md border-0 rounded-3"
                        ...
                        <li>
                            <a class="dropdown-item py-2" href="{{ route('user.profile.index') }}">
                        ...
                        @if(session('impersonating'))
                            <hr class="dropdown-divider">
                            <li>
                                <a class="dropdown-item py-2" href="{{ route('back.to.admin') }}">
                                    <i class="fas fa-arrow-left me-2" style="margin-right: 5px;"></i>Back to Admin
                                </a>
                            </li>
                        @endif
                        <hr class="dropdown-divider">
                ...
                {{-- <li class="nav-item">
                    <a href="{{ route('logout') }}" class="btn btn-block btn-outline-danger btn-sm" style="padding: 8px 15px;">Logout</a>
                </li> --}}
            </ul>
        </nav>
        <!-- /.navbar -->
